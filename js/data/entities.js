...
rijnmond:{
  ...
  wijken:['Kralingen','Delfshaven','Feijenoord','Lombardijen','Ommoord','Hoogvliet','Pernis','Rozenburg','Overschie','Hillegersberg','Schiebroek','Charlois','IJsselmonde','Prins Alexander','Zuidwijk','Pendrecht','Katendrecht','Kop van Zuid','Crooswijk','Blijdorp','Nesselande','Carnisse','Afrikaanderwijk','Bospolder','Tussendijken','Cool','Centrum','West-Kruiskade','Europoort','Botlek','Maasvlakte','Heijplaat'],
...
west:{
  ...
  wijken:['Scheveningen','Loosduinen','Laak','Transvaal','Ypenburg','Leidschenveen','Bezuidenhout','Benoordenhout','Statenkwartier','Archipel','Duinoord','Regentessekwartier','Schilderswijk','Moerwijk','Morgenstond','Bouwlust','Vrederust','Escamp','Mariahoeve','Haagse Hout','Centrum Den Haag','Binckhorst','Kijkduin','Houtwijk','Zuidwest','Segbroek','Bohemen','Waldeck','Vogelwijk','Belgisch Park','Bollenstreek'],
  ...
  landmarks:['Binnenhof','Vredespaleis','Madurodam','Pier Scheveningen','De Pier','Kurhaus','Mall of the Netherlands','Mall of NL','Grote Kerk Den Haag','Haagse Toren','Huis ten Bosch','Paleis Noordeinde','Noordeinde','Panorama Mesdag','Gemeentemuseum','Kunstmuseum Den Haag','Omniversum','AFAS Circustheater','World Forum','Plein','Lange Voorhout','Hofvijver','Passage Den Haag','Keukenhof','Space Expo','Corpus','Archeon','Duinrell','Wassenaarseslag','Meijendel','Kaag','Kagerplassen','Leidse Hout','Pieterskerk Leiden','Universiteit Leiden','TU Delft','Bieslandse Bos','Delftse Hout','Oostpoort Delft'],
  overig:['070','Hofstad','hofstad','Residentie','residentie','HTM','Randstadrail','GGD Haaglanden','Haaglanden','HMC','Haga Ziekenhuis','Haga','LUMC','Reinier de Graaf','Groene Hart Ziekenhuis','Alrijne','Tweede Kamer','Eerste Kamer','Ridderzaal','Prinsjesdag','Hofvijver','Plein 1813']
}
