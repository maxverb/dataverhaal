...
west:{
  ...
  gemeenten:['Den Haag','Delft','Leiden','Zoetermeer','Westland','Rijswijk','Leidschendam-Voorburg','Leidschendam','Voorburg','Wassenaar','Voorschoten','Oegstgeest','Katwijk','Noordwijk','Hillegom','Teylingen','Midden-Delfland','Pijnacker-Nootdorp','Pijnacker','Nootdorp','Alphen aan den Rijn','Nieuwkoop','Bodegraven-Reeuwijk','Bodegraven','Reeuwijk','Waddinxveen','Gouda','Zuidplas','Krimpenerwaard','Kaag en Braassem','Leiderdorp','Zoeterwoude','Sassenheim','Voorhout','Warmond','Naaldwijk','Monster','Wateringen','Kwintsheul'],
